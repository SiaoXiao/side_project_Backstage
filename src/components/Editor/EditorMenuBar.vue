<template>
  <div
    class="sticky inset-0 top-0 z-10 flex flex-wrap items-center px-3 py-2 bg-white border-b border-gray-200 rounded-t-md"
  >
    <template v-for="(item, index) in items" :key="`divider${index}`">
      <div
